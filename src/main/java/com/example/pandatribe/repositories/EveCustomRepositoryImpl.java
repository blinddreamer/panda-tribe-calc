...
public class EveCustomRepositoryImpl implements EveCustomRepository {
    ...
    public BlueprintActivity getBluePrintInfoByProduct(Integer productId) {
        String nativeQuery = "SELECT quantity,typeID ,activityID FROM industryActivityProducts iap WHERE iap.productTypeID =:productId ";
    ...
    public BlueprintActivity getBluePrintInfoByBlueprint(Integer blueprintId) {
        String nativeQuery = "SELECT quantity,typeID, activityID FROM industryActivityProducts iap WHERE iap.typeID =:blueprintId ";
    ...
    public SystemInfo getSystemInfo(String systemName){
        String nativeQuery = "SELECT solarSystemID, security FROM mapSolarSystems mss WHERE mss.solarSystemName = :systemName";
    ...
    public Integer getVolume(Integer typeId){
        String nativeQuery = "SELECT volume FROM invVolumes iv WHERE iv.typeID = :typeId";
    ...
    public List<Blueprint> getBlueprints(){
        String nativeQuery = "SELECT productTypeID FROM industryActivityProducts iap WHERE iap.activityID = 1 OR iap.activityID = 11";
        List<Object> result = entityManager.createNativeQuery(nativeQuery).getResultList();
    ...
    private String getBlueprintName(Integer id){
        String nativeQuery = "SELECT typeName FROM invTypes it WHERE it.typeID = :id";
